...
⚠️ Before deploying the application, ensure the SAP HANA Database is **Running**, Refer to section [Getting Started - 6.6.1. Check and Start SAP HANA Database](/ex0/#66-verify-access-with-different-users)
