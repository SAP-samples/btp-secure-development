...
⚠️ Before deploying the application, ensure the SAP HANA Database is **Running**, Refer to section [6.6.1. Check and Start SAP HANA Databasese](#66-verify-access-with-different-users)
