...
```  
- ✅ Result:
  - **Updates package.json** – The `@cap-js/audit-logging` dependency is automatically added to your project’s [package.json](./package.json) file listed under dependencies.
