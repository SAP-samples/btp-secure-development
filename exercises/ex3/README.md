...
Exercise 3.2 requires a production landscape because writing custom audit log events from applications is only supported with the paid **SAP Audit Log, Premium service plan**. This paid plan is not included in trial accounts.
